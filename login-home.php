...
<header class="navbar navbar-fixed-top">
    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome <?PHP echo $fgmembersite->UserFullName()?> <i
                            class="icon-angle-down"></i></a>
                <ul class="dropdown-menu">
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25"
                ...
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="images/Business_Simulation_Customers.jpg" width="60%" height="100%"
                             alt=""/>
            ...
            <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3"
                ...
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="images/future-technologies.jpg" alt="" width="60%" height="100%"/>
                    ...
                    <div class="carousel-inner">
                        <div class="active item">
                            <div class="row-fluid">
                                <ul class="thumbnails">
                                    <li class="span3">
                                        <a href="#"><img src="images/sample/clients/client1.png"></a>
                                    </li>
                                    <li class="span3">
                                        <a href="#"><img src="images/sample/clients/client2.png"></a>
                                    </li>
                                    <li class="span3">
                                        <a href="#"><img src="images/sample/clients/client3.png"></a>
                                    </li>
                                    <li class="span3">
                        ...
                        <div class="item">
                            <div class="row-fluid">
                                <ul class="thumbnails">
                                    <li class="span3">
                                        <a href="#"><img src="images/sample/clients/client4.png"></a>
                                    </li>
                                    <li class="span3">
                                        <a href="#"><img src="images/sample/clients/client3.png"></a>
                                    </li>
