    ...
    <form class="center" id='register' action='<?php echo $fgmembersite->GetSelfScript(); ?> method="POST" >
        ...
        <input type='hidden' name='submitted' id='submitted' value='1'/>
            ...
            <div class="control-group">
                <!-- Full Name-->
                <div class="controls">
                    <input type='text' name='name' id='name' class="input-xlarge" value='<?php echo $fgmembersite->SafeDisplay('name') ?>' maxlength="50" /><br/>
                </div>
            </div>
            ...
            <div class="control-group">
                <!-- E-mail -->
                <div class="controls">
                    <input type='text' name='email' id='email' placeholder="E-mail" class="input-xlarge" value='<?php echo $fgmembersite->SafeDisplay('email') ?>' maxlength="50" /><br/>
                </div>
            </div>
            ...
            <div class="control-group">
                <!-- Username -->
                <div class="controls">
                    <input type='text' name='username' id='username' value='<?php echo $fgmembersite->SafeDisplay('username') ?>' maxlength="50" class="input-xlarge" /><br/>
                </div>
            </div>
            ...
            <div class="control-group">
                <!-- Button -->
                <div class="controls">
                    <input type='submit' name='Submit' value='Register' class="btn btn-success btn-large btn-block"/>
                </div>
            </div>
        </fieldset>
    </form>
