        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse pull-right">
                <ul class="nav pull-right">
                    ...
                    <li class="login">
                        <a href="register.php"><i class="icon-lock"> Member Login </i></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse pull-right">
                <ul class="nav pull-right">
                    ...
                    <li><a href="contact-us.html">Contact</a></li>
                    <li class="login">
                        <a data-toggle="" href="login.php"><i class="icon-lock"> Member Login </i></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25"
                ...
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src='../resources/images/Business_Simulation_Customers.jpg' width="60%"
                             height="100%"
                             alt=""/>
            ...
            <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3"
                ...
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src='../resources/images/future-technologies.jpg' alt="" width="60%"
                             height="100%"/>
            ...
            <li>
                ...
                <div id="modal-1" class="modal hide fade">
                    ...
                    <div class="modal-body">
                        <img src="../resources/images/portfolio/full/item1.jpg" alt=" " width="100%"
            ...
            <li>
                ...
                <div id="modal-1" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i
                                class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="../resources/images/portfolio/full/item2.jpg" alt=" " width="100%"
                             style="max-height:400px">
                    </div>
                </div>
            </li>
            ...
            <li>
                ...
                <div id="modal-3" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i
                                class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="../resources/images/portfolio/full/item3.jpg" alt=" " width="100%"
                             style="max-height:400px">
                    </div>
                </div>
            </li>
            ...
            <li>
                ...
                <div id="modal-4" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i
                                class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="../resources/images/portfolio/full/item4.jpg" alt=" " width="100%"
                             style="max-height:400px">
                    </div>
                </div>
            </li>
    ...
    <div class="modal-body">
        <form id='login' class="form-horizontal" action="<?php echo $fgmembersite->GetSelfScript(); ?>" method="post"
            ...
            <div class="form-group">
                <!-- Username -->
                <div class='container'>
                    <input type='text' class="input-xxlarge custom_login_form_input_size" name='username' id='username'
                           placeholder="Username"
                           value='<?php echo $fgmembersite->SafeDisplay(' username ') ?>' maxlength="50"
                           style="width: 30%; min-height: 50px; margin-bottom: 10px"/>
            ...
            <div>
                <legend></legend>
                <input type='submit' name='Submit' value='Submit' class="btn-large custom_button_size"
                       style="float: left; width: 30%; height: 50px"/>
                <a href="register.php" class="btn-primary btn-large text-center"
                   style="float: right; width: 30%; height: 30px; font-size: 22px">Sign Up</a>
            </div>
