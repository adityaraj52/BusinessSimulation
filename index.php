        ...
        <ul class="gallery col-4">
            ...
            <li>
                <div class="preview">
                    ...
                    <div class="links">
                        <a  href="#modal-1"><i class="icon-eye-open"></i></a><a href="#"><i
                                    class="icon-link"></i></a>
                    </div>
                </div>
                <div class="desc">
            ...
            <li>
                <div class="preview">
                    ...
                    <div class="links">
                        <a  href="#modal-3"><i class="icon-eye-open"></i></a><a href="#"><i
                                    class="icon-link"></i></a>
                    </div>
                </div>
                <div class="desc">
            ...
            <li>
                <div class="preview">
                    ...
                    <div class="links">
                        <a data-toggle="" href="#modal-4"><i class="icon-eye-open"></i></a><a href="#"><i
                                    class="icon-link"></i></a>
                    </div>
                </div>
                <div class="desc">
